...
## Overview
<a href="https://www.coursicle.com/" target="_blank">Coursicle</a> is a website tailored to Penn State students to help them choose their classes by letting them create a hypothetical schedule and read professor ratings. It is updated often to provide accurate class timings and professors. You can add classes and see how your schedule would look before enrolling in LionPath. Before enrolling, I recommend checking each of your professors to see what each class is like. The professor dictates how a class is run, so it is very important to understand who yours will be. I recommend using this website over <a href="https://www.ratemyprofessors.com/" target="_blank">Rate My Professor</a> because they periodically add Rate My Professor ratings to their own website, while including additional ones of their own.
